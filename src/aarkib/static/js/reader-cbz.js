...
function setupEvents() {
  ...
  if (spreadSelect) {
    spreadSelect.addEventListener("change", (e) => {
      ...
      localStorage.setItem("aarkib-cbz-spread", currentSpread);
  ...
  if (widthSelect) {
    widthSelect.addEventListener("change", (e) => {
      ...
      localStorage.setItem("aarkib-cbz-webtoon-width", currentWebtoonWidth);
      applyWebtoonWidth();
    });
  }
...
function syncProgressDebounced() {
  ...
  progressDebounceTimer = setTimeout(async () => {
    ...
    localStorage.setItem("aarkib-cbz-progress-" + bookId, currentPage.toString());
