...
from buukuu.config import Config
from buukuu.extensions import db, login_manager
from buukuu.routes import api_bp, auth_bp, opds_bp, reader_bp, ui_bp

logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s [%(levelname)s] %(name)s: %(message)s",
)
logger = logging.getLogger("buukuu")
...
def register_commands(app: Flask) -> None:
    ...
    def scan_command():
        ...
        from buukuu.services.scanner import scan_library
    ...
    def enrich_command(book_id, overwrite, provider):
        ...
        from buukuu.services.enricher import enrich_all_books, enrich_book
...
def main() -> None:
    ...
    app = create_app()
    from buukuu.services.scanner import scan_library, start_library_watcher
